...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/traditional-wedding-safa-in-near-me",
    type: "website",
  },
}
...
export default function TraditionalWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
