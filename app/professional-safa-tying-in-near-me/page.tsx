...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/professional-safa-tying-in-near-me",
    type: "website",
  },
}
...
export default function ProfessionalSafaTyingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
