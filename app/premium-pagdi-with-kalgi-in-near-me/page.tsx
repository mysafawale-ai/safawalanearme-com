...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/premium-pagdi-with-kalgi-in-near-me",
    type: "website",
  },
}
...
export default function PremiumPagdiWithKalgiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
