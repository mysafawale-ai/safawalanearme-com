...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/jodhpuri-pagdi-in-near-me",
    type: "website",
  },
}
...
export default function JodhpuriPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
