...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/wedding-safa-draping-in-near-me",
    type: "website",
  },
}
...
export default function WeddingSafaDrapingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India"],
