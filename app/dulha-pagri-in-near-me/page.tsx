...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/dulha-pagri-in-near-me",
    type: "website",
  },
}
...
export default function DulhaPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert pagri specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
