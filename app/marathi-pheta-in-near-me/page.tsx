...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/marathi-pheta-in-near-me",
    type: "website",
  },
}
...
export default function MarathiPhetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
