...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/safa-tying-service-in-near-me",
    type: "website",
  },
}
...
export default function SafaTyingServiceInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],
