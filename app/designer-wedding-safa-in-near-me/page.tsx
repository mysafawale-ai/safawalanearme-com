...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/designer-wedding-safa-in-near-me",
    type: "website",
  },
}
...
export default function DesignerWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
