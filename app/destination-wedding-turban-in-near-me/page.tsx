...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/destination-wedding-turban-in-near-me",
    type: "website",
  },
}
...
export default function DestinationWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day"],
