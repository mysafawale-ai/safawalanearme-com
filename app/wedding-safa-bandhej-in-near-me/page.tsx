...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/wedding-safa-bandhej-in-near-me",
    type: "website",
  },
}
...
export default function WeddingSafaBandhejInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
