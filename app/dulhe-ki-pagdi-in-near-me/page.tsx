...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/dulhe-ki-pagdi-in-near-me",
    type: "website",
  },
}
...
export default function DulheKiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics"],
