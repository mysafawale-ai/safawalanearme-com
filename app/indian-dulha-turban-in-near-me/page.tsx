...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/indian-dulha-turban-in-near-me",
    type: "website",
  },
}
...
export default function IndianDulhaTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Expert turban specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
