...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/royal-wedding-turban-for-groom-in-near-me",
    type: "website",
  },
}
...
export default function RoyalWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
