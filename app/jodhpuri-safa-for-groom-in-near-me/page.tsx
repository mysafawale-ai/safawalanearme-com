...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/jodhpuri-safa-for-groom-in-near-me",
    type: "website",
  },
}
...
export default function JodhpuriSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue"],
