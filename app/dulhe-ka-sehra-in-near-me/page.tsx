...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/dulhe-ka-sehra-in-near-me",
    type: "website",
  },
}
...
export default function DulheKaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert sehra specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
