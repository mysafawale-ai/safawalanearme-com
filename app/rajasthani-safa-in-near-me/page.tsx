...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/rajasthani-safa-in-near-me",
    type: "website",
  },
}
...
export default function RajasthaniSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Emergency last-minute service available in India"],
