...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/custom-wedding-turban-for-overseas-weddings-in-near-me",
    type: "website",
  },
}
...
export default function CustomWeddingTurbanForOverseasWeddingsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
