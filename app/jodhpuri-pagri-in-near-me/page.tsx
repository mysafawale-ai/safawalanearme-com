...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/jodhpuri-pagri-in-near-me",
    type: "website",
  },
}
...
export default function JodhpuriPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagri specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
