...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/rajputi-safa-design-in-near-me",
    type: "website",
  },
}
...
export default function RajputiSafaDesignInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
