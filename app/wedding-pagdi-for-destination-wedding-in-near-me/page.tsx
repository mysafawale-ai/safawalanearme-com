...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalanearme.com/wedding-pagdi-for-destination-wedding-in-near-me",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit"],
